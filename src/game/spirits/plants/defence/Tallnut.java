...
public class Tallnut extends AbstractDefence {
    private static final String health = "Tallnut-main";
    private static final String cracked1 = "Tallnut-cracked1";
    private static final String cracked2 = "Tallnut-cracked2";
    ...
    public Tallnut(MapLawn mapLawn) {
        super(mapLawn);
    }
